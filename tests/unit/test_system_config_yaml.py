...
class TestSystemConfigYAMLLoading:
    ...
    def create_yaml_config(self, config_dict: dict) -> str:
    ...
    def test_from_yaml_with_complete_config(self):
        ...
        try:
            ...
            assert config.allowed_extensions == {'pdf', 'txt'}
    ...
    def test_from_yaml_boolean_variations(self):
        ...
        for value, expected in test_cases:
            config_data = {
                'tts': {'engine': 'piper'},
                'text_processing': {'enable_text_cleaning': value}
            }
    ...
    def test_from_yaml_range_validation(self):
        ...
        config_data = {
            'tts': {'engine': 'piper'},
            'files': {'max_file_size_mb': 0}  # Min is 1
        }
        ...
        config_data = {
            'tts': {'engine': 'piper'},
            'files': {'max_file_size_mb': 2000}  # Max is 1000
        }
    ...
    def test_from_yaml_list_and_string_extensions(self):
        ...
        try:
            config = SystemConfig.from_yaml(config_file)
            assert config.allowed_extensions == {'pdf', 'txt', 'doc'}
