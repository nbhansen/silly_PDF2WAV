...
class TestAudioEngine:
    ...
    def test_audio_engine_creation(self):
        ...
        engine = AudioEngine(
            ...
            timing_engine=mock_timing_engine
        )
    ...
    def test_audio_engine_delegates_to_timing_engine(self):
        ...
        expected_result = TimedAudioResult(
...
class TestTimingEngine:
    ...
    def test_timing_engine_mode_selection(self):
        ...
        engine = TimingEngine(
            tts_engine=mock_timestamped_tts,
            file_manager=mock_file_manager,
            mode=TimingMode.ESTIMATION
        )
        ...
        engine2 = TimingEngine(
            tts_engine=mock_basic_tts,
            file_manager=mock_file_manager,
            mode=TimingMode.ESTIMATION
        )
    ...
    def test_timing_engine_estimation_mode(self):
        ...
        mock_segments = [
            TextSegment(text="Test", start_time=0.0, duration=1.0, segment_type="sentence", chunk_index=0, sentence_index=0)
        ]
...
class TestTextPipeline:
    ...
    def test_text_pipeline_sentence_splitting(self):
        ...
        assert "This is sentence one." == sentences[0]
        assert "This is sentence two!" == sentences[1]
        assert "Is this sentence three?" == sentences[2]
        assert "This is a longer sentence." == sentences[3]
...
class TestServiceContainer:
    ...
    def test_service_container_registration_and_retrieval(self):
        ...
        container.register(str, lambda: test_service)
    ...
    def test_service_container_singleton_behavior(self):
        ...
        container.register(str, factory)
...
class TestArchitectureIntegration:
    ...
    def test_audio_and_timing_engine_integration(self):
        ...
        mock_segments = [TextSegment(text="Test", start_time=0.0, duration=1.0, segment_type="sentence", chunk_index=0, sentence_index=0)]
